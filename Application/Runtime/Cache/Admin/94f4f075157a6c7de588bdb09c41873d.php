        ...
        <div id="user_login">
            <dl>
                <dd id="user_top">
                    ...
                    <form action="/index.php/admin/back/login" method="POST">
                        <ul>
                            ...
                            <li class="user_main_c">
                                <div class="user_main_box">
                                    ...
                                    <ul>
                                        ...
                                        <li class="user_main_input" style="position: relative;">
                                            <input class="TxtValidateCodeCssClass" id="captcha" name="code" type="text">
                                            <img id="img001" src="/index.php/Admin/Back/code" style="position: absolute;top: 30px; left: 25px;cursor:pointer;" alt="" onclick="this.src='/index.php/Admin/Back/code/' + Math.random();" />
                                        </li>
                                    </ul>
                                </div>
                            </li>
